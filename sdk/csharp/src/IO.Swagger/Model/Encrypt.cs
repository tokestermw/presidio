...
namespace IO.Swagger.Model
{
        ...
        public partial class Encrypt :  IEquatable<Encrypt>, IValidatableObject
    {
        ...
        public Encrypt(string type = default(string), string key = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Encrypt and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for Encrypt and cannot be null");
            }
            else
            {
                this.Key = key;
