...
namespace IO.Swagger.Model
{
        ...
        public partial class Decrypt :  IEquatable<Decrypt>, IValidatableObject
    {
        ...
        public Decrypt(string type = default(string), string key = default(string))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Decrypt and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for Decrypt and cannot be null");
            }
            else
            {
                this.Key = key;
