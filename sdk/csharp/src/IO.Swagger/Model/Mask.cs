...
namespace IO.Swagger.Model
{
        ...
        public partial class Mask :  IEquatable<Mask>, IValidatableObject
    {
        ...
        public Mask(string type = default(string), string maskingChar = default(string), int? charsToMask = default(int?), bool? fromEnd = false)
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Mask and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (maskingChar == null)
            {
                throw new InvalidDataException("maskingChar is a required property for Mask and cannot be null");
            }
            else
            {
                this.MaskingChar = maskingChar;
            }
            // to ensure "charsToMask" is required (not null)
            if (charsToMask == null)
            {
                throw new InvalidDataException("charsToMask is a required property for Mask and cannot be null");
            }
            else
            {
                this.CharsToMask = charsToMask;
            }
            // use default value if no "fromEnd" provided
            if (fromEnd == null)
            {
                this.FromEnd = false;
            }
        ...
        [DataMember(Name="masking_char", EmitDefaultValue=false)]
        ...
        [DataMember(Name="chars_to_mask", EmitDefaultValue=false)]
