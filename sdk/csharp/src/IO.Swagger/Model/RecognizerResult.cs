...
namespace IO.Swagger.Model
{
        ...
        public partial class RecognizerResult :  IEquatable<RecognizerResult>, IValidatableObject
    {
        ...
        public RecognizerResult(int? start = default(int?), int? end = default(int?), double? score = default(double?), string entityType = default(string))
        {
            ...
            if (start == null)
            {
                throw new InvalidDataException("start is a required property for RecognizerResult and cannot be null");
            }
            else
            {
                this.Start = start;
            ...
            if (end == null)
            {
                throw new InvalidDataException("end is a required property for RecognizerResult and cannot be null");
            }
            else
            {
                this.End = end;
            ...
            if (score == null)
            {
                throw new InvalidDataException("score is a required property for RecognizerResult and cannot be null");
            }
            else
            {
                this.Score = score;
            ...
            if (entityType == null)
            {
                throw new InvalidDataException("entityType is a required property for RecognizerResult and cannot be null");
            }
            else
            {
