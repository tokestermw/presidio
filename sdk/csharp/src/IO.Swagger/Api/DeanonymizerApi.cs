...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IDeanonymizerApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class DeanonymizerApi : IDeanonymizerApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeanonymizerApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DeanonymizerApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DeanonymizerApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< DeanonymizeResponse > DeanonymizePostWithHttpInfo (DeanonymizeRequest body)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DeanonymizerApi->DeanonymizePost");
