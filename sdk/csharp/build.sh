...
${nuget_cmd} install src/Microsoft.Presidio/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Microsoft.Presidio.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Microsoft.Presidio.dll \
-recurse:'src/Microsoft.Presidio/*.cs' \
-doc:bin/Microsoft.Presidio.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Microsoft.Presidio.dll was created successfully"
fi
